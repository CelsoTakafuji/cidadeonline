...
<div class="site-container">
    ...
    <section class="page_empresas">
        <header class="emp_header">
            <h2><?= $Cat != '' ? $Cat : 'Todas categorias'; ?></h2>
		...
		if($Cat != ''){
			...
			$readEmp->ExeRead("app_empresas", "WHERE empresa_status = 1 ORDER BY empresa_date DESC LIMIT :limit OFFSET :offset", "limit={$Pager->getLimit()}&offset={$Pager->getOffset()}");
		}
